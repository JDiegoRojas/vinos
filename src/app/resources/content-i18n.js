            ...
            experiences: [
                {
                    ...
                    images: [ // optional: leave the array empty if you don't want to display images
                        {
                            src: '/images/projects/project-01/vino01.jpg',
                            alt: 'Once UI Project',
                            width: 16,
                            height: 9
                        }
            ...
            skills: [
                {
                    ...
                    images: [
                        {
                            src: '/images/projects/project-01/vino02.jpg',
                            alt: 'Project image',
                            width: 16,
                            height: 9
                        },
                        {
                            src: '/images/projects/project-01/vino03.jpg',
                            alt: 'Project image',
                            width: 16,
                            height: 9
                        },
                ...
                },
                {
                    ...
                    images: [
                        {
                            src: '/images/projects/project-01/vino04.jpg',
                            alt: 'Project image',
                            width: 16,
                            height: 9
                        },
